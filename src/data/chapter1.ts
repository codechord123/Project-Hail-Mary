...
export const chapter1Problems: Chapter1Problem[] = [
  // 이분모 덧셈 5문항 — 모두 통분 + 일부 약분 요구
  {
    ...
    hint: '공통분모 6. 1/2 = 3/6, 1/3 = 2/6 → 5/6.',
    scene: 'oxygen',
  },
  {
    kind: 'manipulation',
    ...
    operation: 'add',
    requireSimplified: true,
    hint: '공통분모 12. 3/12 + 5/12 = 8/12 → 약분 ÷4.',
    scene: 'water',
  },
  {
    kind: 'manipulation',
...
export const CHAPTER1_APPLICATION_POOL: ApplicationProblem[] = [
  ...
  },
  {
    ...
    problem: {
      ...
      prompt: '0.36 + 1/4 (기약)',
      hint: '0.36 = 9/25, 1/4 = 25/100. 9/25 + 1/4 = 36/100 + 25/100 = 61/100.',
