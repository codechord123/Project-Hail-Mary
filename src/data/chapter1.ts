...
export const chapter1Problems: Chapter1Problem[] = [
  ...
  },
  {
    ...
    id: 'c1-2',
    story:
      '수경 재배기 1번 칸에 물이 1/3, 2번 칸에 1/6 차 있어. 통분해 한 통에 모아. (기약분수로!)',
    a: { numerator: 1, denominator: 3 },
    b: { numerator: 1, denominator: 6 },
    operation: 'add',
    requireSimplified: true,
    hint: '공통분모 6. 1/3 = 2/6. 2/6 + 1/6 = 3/6 → 약분!',
    scene: 'water',
  },
  {
    kind: 'manipulation',
    id: 'c1-3',
    story: '연료 셀1 = 1/4, 셀2 = 3/8 을 합성기에 모아봐. 분모를 맞춰야 해.',
    a: { numerator: 1, denominator: 4 },
    b: { numerator: 3, denominator: 8 },
    operation: 'add',
    requireSimplified: false,
    hint: '공통분모 8. 1/4 = 2/8. 2/8 + 3/8 = ?',
    scene: 'fuel',
  },
  {
    kind: 'manipulation',
    id: 'c1-4',
    story:
      '비상 배터리 A=1/2, B=1/6. 통분해 충전기에 모아봐. (기약분수로!)',
    a: { numerator: 1, denominator: 2 },
    b: { numerator: 1, denominator: 6 },
    operation: 'add',
    requireSimplified: true,
    hint: '공통분모 6. 1/2 = 3/6. 3/6 + 1/6 = 4/6 → 약분!',
    scene: 'battery',
  },
  {
    kind: 'manipulation',
    id: 'c1-5',
    story:
      '항법 코드 조각1=1/4, 조각2=1/3 을 메인 모듈로 옮겨. 가장 작은 공통분모를 찾아!',
    a: { numerator: 1, denominator: 4 },
    b: { numerator: 1, denominator: 3 },
    operation: 'add',
    requireSimplified: false,
    hint: '공통분모 12. 1/4 = 3/12, 1/3 = 4/12. 3/12 + 4/12 = ?',
    scene: 'code',
  },
]
